...
FlowRouter.route( '/editfilled', {
  action: function() {

    if (Meteor.userId()) {
        BlazeLayout.render( 'applicationLayout', { top: 'Header', main: 'EditFilledBlanks', bottom: 'Footer' } );
